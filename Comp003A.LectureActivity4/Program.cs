 ...
 * Reference:https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-statement
 */
 ...
 namespace Comp003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int counter3 = 0; // initial1 counter3 value;
            ...
            // 1. loop variable '1' is set 1 instead of 0
